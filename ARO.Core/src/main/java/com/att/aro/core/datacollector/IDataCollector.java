...
//	StatusResult startCollector(String folderToSaveTrace);
	 ...
	 * @return a StatusResult to hold result and success or failure
	 */
	StatusResult startCollector(boolean isCommandLine, String folderToSaveTrace, VideoOption videoOption, String password);
	...
	/**
	 * Access device to retrieve the serial number/udid
	 * @param status
	 * @return serial number
	 */
	String[] getDeviceSerialNumber(StatusResult status);
