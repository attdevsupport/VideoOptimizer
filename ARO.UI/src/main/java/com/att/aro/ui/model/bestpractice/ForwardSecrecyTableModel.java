...
public class ForwardSecrecyTableModel extends DataTableModel<ForwardSecrecyEntry> {
	...
	public ForwardSecrecyTableModel() {
		super(COLUMNS);
	}
	...
	@Override
	protected Object getColumnValue(ForwardSecrecyEntry item, int columnIndex) {
		switch (columnIndex) {
		case COL_1:
