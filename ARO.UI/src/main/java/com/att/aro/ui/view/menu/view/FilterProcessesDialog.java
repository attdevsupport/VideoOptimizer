...
public class FilterProcessesDialog extends JDialog {
	...
	private FilteredProcessSelection filteredProcessSelection;
	...
	public FilterProcessesDialog(IAROView parent, JMenuItem callerMenuItem) {
		...
		if (analysisData != null) {
			...
			if (filteredProcessSelection == null) {
				filteredProcessSelection = new FilteredProcessSelection(cpuAList);
			}
			this.jProcessesTableModel = new FilterProcessesTableModel(filteredProcessSelection);

			// create copy of the original filter
			this.filteredProcessSelectionCopy = new FilteredProcessSelection(filteredProcessSelection);
	...
	private void cancelButtonAction() {
		filteredProcessSelection = this.filteredProcessSelectionCopy;
		callerMenuItem.setEnabled(true);		
		dispose();
