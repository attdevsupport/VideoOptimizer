...
public class AdAnalyticsTableModel extends DataTableModel<MultipleConnectionsEntry> {
	/**
	 *
	 */
	...
	private static final String[] COLUMNS = {
			...
			ResourceBundleHelper.getMessageString("connections.adAnalytics.table.col4") };

	public AdAnalyticsTableModel() {
		super(COLUMNS);
	}
