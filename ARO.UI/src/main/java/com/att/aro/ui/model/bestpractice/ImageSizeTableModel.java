...
public class ImageSizeTableModel extends DataTableModel<ImageSizeEntry> {
	...
	private static final Logger LOGGER = LogManager.getLogger(ImageSizeTableModel.class.getName());
	...
	protected Object getColumnValue(ImageSizeEntry item, int columnIndex) {
		ImageSizeTableModel.LOGGER.trace(format("getColumnValue, idx:{0}", columnIndex));
		switch (columnIndex) {
		case COL_1:
