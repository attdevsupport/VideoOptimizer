...
public class RrcStateMachineFactoryImplTest extends BaseTest {
	...
	@Before
	public void setUp() {
		machineFactoryimpl = (RrcStateMachineFactoryImpl) context.getBean(IRrcStateMachineFactory.class);// put
																											// ahead
	...
	public void create_TimeRangeIsNotNull() {
		...
		AbstractRrcStateMachine rrcStateMachinewifi = machineFactoryimpl.create(packetlist1, profile01, packetDuration,
				traceDuration, 0.0, timeRange);
	...
	public void create_WIFIStateIsWIFI_ACTIVE() {
		...
		when(profilefactory.energyWiFi(any(double.class), any(double.class), any(RRCState.class),
				any(ProfileWiFi.class))).thenReturn(2.0);
		when(rrc01.getState()).thenReturn(RRCState.WIFI_ACTIVE);
		staterangelist.add(rrc01);
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineWiFi rrcStateMachineWifi = (RrcStateMachineWiFi) machineFactoryimpl.create(packetlist2,
				profile02, packetDuration, traceDuration, totalBytes, null);
	...
	public void create_WIFIStateIsWIFI_TAIL() {
		...
		when(profilefactory.energyWiFi(any(double.class), any(double.class), any(RRCState.class),
				any(ProfileWiFi.class))).thenReturn(100.0);
		List<PacketInfo> packetlist1 = new ArrayList<PacketInfo>();
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		...
		RrcStateMachineWiFi rrcStateMachineWifi = (RrcStateMachineWiFi) machineFactoryimpl.create(packetlist1,
				profile17, packetDuration, traceDuration, totalBytes * 100, null);
	...
	public void create_WIFIStateIsWIFI_IDLE() {
		...
		RrcStateMachineWiFi rrcStateMachineWifi = (RrcStateMachineWiFi) machineFactoryimpl.create(packetlist1,
				profile18, packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50, rrcStateMachineWifi.getJoulesPerKilobyte(), 0.0);
	...
	public void create_LTEStateIsLTE_IDLE() {
		...
		when(profilefactory.energyLTE(any(double.class), any(double.class), any(RRCState.class), any(ProfileLTE.class),
				any(ArrayList.class))).thenReturn(100.0);
		List<PacketInfo> packetlist1 = new ArrayList<PacketInfo>();
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		RrcStateRange[] rrcStateRangeArray = new RrcStateRange[5];
		for (int i = 0; i < 5; i++) {
		...
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile03,
				packetDuration, traceDuration, totalBytes * 100, null);
	...
	public void create_LTEStateIsLTE_PROMOTION() {
		...
		when(profilefactory.energyLTE(any(double.class), any(double.class), any(RRCState.class), any(ProfileLTE.class),
				any(ArrayList.class))).thenReturn(5.0);
		List<PacketInfo> packetlist1 = new ArrayList<PacketInfo>();
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		RrcStateRange[] rrcStateRangeArray = new RrcStateRange[5];
		for (int i = 0; i < 5; i++) {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile04,
				packetDuration, traceDuration, totalBytes * 1000, null);
	...
	public void create_LTEStateIsLTE_CONTINUOUS() {
		...
		when(profilefactory.energyLTE(any(double.class), any(double.class), any(RRCState.class), any(ProfileLTE.class),
				any(ArrayList.class))).thenReturn(4.0);
		List<PacketInfo> packetlist1 = new ArrayList<PacketInfo>();
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		RrcStateRange[] rrcStateRangeArray = new RrcStateRange[5];
		for (int i = 0; i < 5; i++) {
		...
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile05,
				packetDuration, traceDuration, totalBytes * 100, null);
	...
	public void create_LTEStateIsLTE_CR_TAIL() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile06,
				packetDuration, traceDuration, totalBytes * 200, null);
	...
	public void create_LTEStateIsLTE_DRX_SHORT() {
		...
		when(profilefactory.energyLTE(any(double.class), any(double.class), any(RRCState.class), any(ProfileLTE.class),
				any(ArrayList.class))).thenReturn(6.0);
		List<PacketInfo> packetlist1 = new ArrayList<PacketInfo>();
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		RrcStateRange[] rrcStateRangeArray = new RrcStateRange[5];
		for (int i = 0; i < 5; i++) {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile07,
				packetDuration, traceDuration, totalBytes * 125, null);
	...
	public void create_LTEStateIsLTE_DRX_LONG() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile08,
				packetDuration, traceDuration, totalBytes * 125, null);
		assertEquals(2.4, rrcStateMachineLTE.getJoulesPerKilobyte(), 0.0);
	...
	public void create_LTEStateRrcStateRangeListIsEmpty() {
		...
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachineLTE rrcStateMachineLTE = (RrcStateMachineLTE) machineFactoryimpl.create(packetlist1, profile09,
				packetDuration, traceDuration, 0 * totalBytes, null);
	...
	public void create_T3GStateIsSTATE_IDLE() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile10,
				packetDuration, traceDuration, totalBytes * 100, null);
	...
	public void create_T3GStateIsSTATE_DCH() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile11,
				packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50.0, rrcStateMachine3G.getJoulesPerKilobyte(), 0.0);
	...
	public void create_T3GStateIsSTATE_FACH() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile12,
				packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50.0, rrcStateMachine3G.getJoulesPerKilobyte(), 0.0);
	...
	public void create_T3GStateIsTAIL_FACH() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile13,
				packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50.0, rrcStateMachine3G.getJoulesPerKilobyte(), 0.0);
	...
	public void create_T3GStateIsPROMO_IDLE_DCH() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile14,
				packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50.0, rrcStateMachine3G.getJoulesPerKilobyte(), 0.0);
	...
	public void create_T3GStateIsPROMO_FACH_DCH() {
		...
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile15,
				packetDuration, traceDuration, totalBytes * 100, null);
		assertEquals(50.0, rrcStateMachine3G.getJoulesPerKilobyte(), 0.0);
	...
	public void create_3GStateRrcStateRangeListIsEmpty() {
		...
		List<RrcStateRange> staterangelist = new ArrayList<RrcStateRange>();
		when(staterange.create(any(ArrayList.class), any(Profile.class), any(double.class))).thenReturn(staterangelist);
		RrcStateMachine3G rrcStateMachine3G = (RrcStateMachine3G) machineFactoryimpl.create(packetlist1, profile16,
				packetDuration, traceDuration, 0 * totalBytes, null);
