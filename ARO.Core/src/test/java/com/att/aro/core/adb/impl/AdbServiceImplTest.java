...
public class AdbServiceImplTest extends BaseTest {
	 ...
	 * scripted
	 * <p>
	 * after init(...) getBridge and createBridge return androidDebugBridge object
	 * </p>
	 * <p>
	 * before init(...) getBridge and createBridge return null
	 * </p>
	 * <p>
	 * In reality getBridge and createBridge return an ADB but it is unstable and causes exceptions
	 * </p>
	 */
	@Test
