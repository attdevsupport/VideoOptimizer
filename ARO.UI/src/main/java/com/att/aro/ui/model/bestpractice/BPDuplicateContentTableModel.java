...
public class BPDuplicateContentTableModel extends DataTableModel<CacheEntry> {
	...
	private static final String[] columns = { ResourceBundleHelper.getMessageString("duplicate.table.col0") // File Size
	 ...
	 */
	public BPDuplicateContentTableModel() {
		super(columns);
	}
