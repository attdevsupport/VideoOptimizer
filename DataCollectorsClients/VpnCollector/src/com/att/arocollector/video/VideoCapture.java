...
public class VideoCapture {
    ...
    private void setScreenDimensions(String screenSize) {
	    ...
	    String tmpHeight = screenSize.split("x")[0];
	    String tmpWidth = screenSize.split("x")[1];	
	    screenHeight = isInteger(tmpHeight)? Integer.valueOf(tmpHeight) : screenHeight;
	    screenWidth = isInteger(tmpWidth)? Integer.valueOf(tmpWidth) : screenWidth;
    }
