...
public class ImageComparatorDataTable<T> extends JTable {
	 ...
	 * available.
	 */
	public ImageComparatorDataTable() {
		this(null, null);
	}
	 ...
	 *            The table model.
	 */
	public ImageComparatorDataTable(DataTableModel<T> dtm) {
	 ...
	 */
	public ImageComparatorDataTable(DataTableModel<T> dtm, TableColumnModel tcm) {
		super(dtm, tcm);
