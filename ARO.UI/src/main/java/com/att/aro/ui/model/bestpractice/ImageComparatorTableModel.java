...
public class ImageComparatorTableModel extends DataTableModel<ImageMdataEntry> {
	...
	private static final Logger LOGGER = LogManager.getLogger(ImageComparatorTableModel.class.getName());
	...
	protected Object getColumnValue(ImageMdataEntry item, int columnIndex) {
		ImageComparatorTableModel.LOGGER.trace(format("getColumnValue, idx:{0}", columnIndex));
		switch (columnIndex) {
		case COL_1:
