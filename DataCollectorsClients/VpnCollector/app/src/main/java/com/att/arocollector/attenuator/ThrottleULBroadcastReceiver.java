...
public class ThrottleULBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int ulMs = intent.getIntExtra("ulms", AttenuatorUtil.DEFAULT_THROTTLE_SPEED);
        if (mBuilder == null) {
        ...
        Log.i(TAG, "Upload stream throttle for: " + ulMs + " kbps");
        AttenuatorManager.getInstance().setThrottleUL(ulMs);
        String text = "Upload stream throttle for " + AttenuatorUtil.getInstance().messageConvert(ulMs);
