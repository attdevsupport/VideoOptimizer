...
//	private static final Logger logger = Logger.getLogger(AbstractBpDetailTablePanel.class.getName());
	...
	ImageComparatorDataTable<ImageMdataEntry> contentTable;
	...
	public AbstractBpImageComparatorTablePanel() {
		initTableModel();
	...
	@SuppressWarnings("rawtypes")
	public abstract ImageComparatorDataTable getContentTable();
