...
public class ImageMetaDataTable<T> extends JTable {
	 ...
	 *            The table model.
	 */
	public ImageMetaDataTable(DataTableModel<T> dtm) {
	 ...
	 */
	public ImageMetaDataTable(DataTableModel<T> dtm, TableColumnModel tcm) {
		super(dtm, tcm);
