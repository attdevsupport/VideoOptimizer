...
/**
 * store information about a socket connection from a VPN client. Each session
...
public class Session {
	...
	/**
	 * track how many bytes sent to client since last ACK to avoid overloading
	 * 
	 * @param amount
	 */
	...
	public void setSocketchannel(SocketChannel socketchannel) {
		Log.d(TAG, "setSocketchannel socketchannel:" + socketchannel);
