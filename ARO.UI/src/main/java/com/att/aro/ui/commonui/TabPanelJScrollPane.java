...
public abstract class TabPanelJScrollPane extends JScrollPane implements Observer,
	...
	/**
	 * set up title to related session map so that user could click the title in UI and being directed to the related session
	 * only available for JScrollPane and subclass
	 */
	public abstract void setScrollLocationMap();
