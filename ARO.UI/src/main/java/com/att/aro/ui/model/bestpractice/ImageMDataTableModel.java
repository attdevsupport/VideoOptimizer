 ...
 * objects.
 */
public class ImageMDataTableModel extends DataTableModel<ImageMdataEntry> {

	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = Logger.getLogger(ImageMDataTableModel.class.getName());
	 ...
	 */
	public ImageMDataTableModel() {
		super(ImageMDataTableModel.COLUMNS);
	}
	...
	public TableColumnModel createDefaultTableColumnModel() {
		...
		col = cols.getColumn(ImageMDataTableModel.COL_1);
		col.setCellRenderer(new NumberFormatRenderer(new DecimalFormat("0.000")));
		col.setMinWidth(ImageMDataTableModel.COL1_MIN);
		col.setPreferredWidth(ImageMDataTableModel.COL1_PREF);
		col.setMaxWidth(ImageMDataTableModel.COL1_MAX);

		col = cols.getColumn(ImageMDataTableModel.COL_2);
		col.setMinWidth(ImageMDataTableModel.COL2_MIN);
		col.setPreferredWidth(ImageMDataTableModel.COL2_PREF);
		col.setMaxWidth(ImageMDataTableModel.COL2_MAX);

		col = cols.getColumn(ImageMDataTableModel.COL_3);
		col.setMinWidth(ImageMDataTableModel.COL3_MIN);
		col.setPreferredWidth(ImageMDataTableModel.COL3_PREF);
		col.setMaxWidth(ImageMDataTableModel.COL3_MAX);

		col = cols.getColumn(ImageMDataTableModel.COL_4);
		col.setMinWidth(ImageMDataTableModel.COL4_MIN);
		col.setPreferredWidth(ImageMDataTableModel.COL4_PREF);
		col.setMaxWidth(ImageMDataTableModel.COL4_MAX);
		
		col = cols.getColumn(ImageMDataTableModel.COL_5);
		col.setMinWidth(ImageMDataTableModel.COL5_MIN);
		col.setPreferredWidth(ImageMDataTableModel.COL5_PREF);
		col.setMaxWidth(ImageMDataTableModel.COL5_MAX);
	...
	public Class<?> getColumnClass(int columnIndex) {
		ImageMDataTableModel.LOGGER.log(Level.FINE, "getColumnClass, idx: {0}", columnIndex);
		switch (columnIndex) {
		case COL_1:
			return Double.class;
		case COL_2:
	...
	protected Object getColumnValue(ImageMdataEntry item, int columnIndex) {
		ImageMDataTableModel.LOGGER.log(Level.FINEST, "getColumnValue, idx:{0}", columnIndex);
		switch (columnIndex) {
		case COL_1:
