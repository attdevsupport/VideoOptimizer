...
public class VideoTcpConnectionImplTest extends BaseTest{

	private VideoTcpConnectionImpl videoTcpConnection;
	...
	@Before
	public void setup() {
		videoTcpConnection = (VideoTcpConnectionImpl) context.getBean("tcpConnection");
	...
	public void runTest_all_invalid_Manifests_should_CONFIG_REQUIRED(){		
		...
		VideoTcpConnectionResult result = (VideoTcpConnectionResult) videoTcpConnection.runTest(tracedata);
	...
	public void runTest_one_selected_Manifest_expect_SELFTEST(){
		...
		VideoTcpConnectionResult result = (VideoTcpConnectionResult) videoTcpConnection.runTest(tracedata);
		assertThat(result.getResultText()).contains("Video Optimizer detected 1 separate HTTP connection for a single video.");
