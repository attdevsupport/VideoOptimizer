...
public class FFprobeConfirmationDialog extends ConfirmationDialog {
	...
	public FFprobeConfirmationImpl ffprobeImpl = ContextAware.getAROConfigContext().getBean("ffprobeConfirmationImpl", FFprobeConfirmationImpl.class);

	public void createDialog() {
		setUndecorated(false);
		setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		setTitle(resourceBundle.getString("ffprobe.dialog.title"));
		setResizable(false);
		...
		okBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (dontShowAgainCheckBox.isSelected()) {
					ffprobeImpl.saveFfprobeDontShowAgainStatus(true);
				}
				dispose();
			}
		});
	...
	public String getLabelMsg() {
		return resourceBundle.getString("ffprobe.dialog.message");
	}
}
