 ...
 *     
 */
public class SSMStreamIndexAmz {
	private String type;
	private String name;
	...
	private ArrayList<SSMQualityLevelAmz> qualityLevelList;
...
//		strblr.append(", displayHeight :");         strblr.append(displayHeight);      
	...
	public ArrayList<SSMQualityLevelAmz> getQualityLevelList() {
	...
	public void setQualityLevelList(ArrayList<SSMQualityLevelAmz> qualityLevelList) {
