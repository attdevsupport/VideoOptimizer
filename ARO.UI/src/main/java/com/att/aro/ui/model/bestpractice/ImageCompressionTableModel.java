...
public class ImageCompressionTableModel extends DataTableModel<ImageCompressionEntry> {
	...
	private static final Logger LOGGER = Logger.getLogger(ImageCompressionTableModel.class.getName());
	...
	public Class<?> getColumnClass(int columnIndex) {
		ImageCompressionTableModel.LOGGER.log(Level.FINE, "getColumnClass, idx: {0}", columnIndex);
		switch (columnIndex) {
		case COL_1:
			return Double.class;
		case COL_2:
	...
	protected Object getColumnValue(ImageCompressionEntry item, int columnIndex) {
		ImageCompressionTableModel.LOGGER.log(Level.FINEST, "getColumnValue, idx:{0}", columnIndex);
		switch (columnIndex) {
		case COL_1:
