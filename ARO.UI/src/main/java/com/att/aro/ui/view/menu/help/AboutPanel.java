...
public class AboutPanel extends JPanel {
	...
	private JPanel getAboutPanel() {
		if (aboutPanel == null) {
			...
			JLabel buildLabel = new JLabel(MessageFormat.format(RES_BUN.getString("About.build"), ResourceBundleHelper.getBuildString(MAJOR_VERSION_KEY) + "." + ResourceBundleHelper.getBuildString(BUILD_VERSION_KEY)), SwingConstants.CENTER);
			
			String titleLabelName = MessageFormat.format(RES_BUN.getString("About.name"), 
			...
			JLabel swLabel = new JLabel(labelName, SwingConstants.CENTER);
	...
	private JLabel getJReleaseNotePanel() {
		...
		releaseNoteLabel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				new BrowserLauncher().launchURI(url,
						AboutPanel.this);
			}
		});
