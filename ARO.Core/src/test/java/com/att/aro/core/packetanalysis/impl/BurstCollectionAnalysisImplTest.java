...
public class BurstCollectionAnalysisImplTest extends BaseTest {
	...
	public void analyzeTest() {
		...
		BurstCollectionAnalysisData bcaData = aBurstCollectionAnalysis.analyze(packetsList, profile,
				packetSizeToCountMap, rrcstaterangelist, uEventList, cpuActivityList, sessionList);
