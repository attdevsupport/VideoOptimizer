...
public class DisplayNoneInCSSImpl implements IBestPractice {
	 ...
	 * 
	 * @return Document, the parsed HTML file, may be null
	 */
	...
	private boolean checkIfDisplayNoneIsPresentInCSSembeddedInHTML(Document doc) {
		...
		for (Element element : elements) {
			...
			if ((element.tagName().equalsIgnoreCase("style")) && (element.toString().contains("text/css")) && element.text().contains("display:none")) {
				return true;
			}
		}
