...
public class HttpRequestResponseInfo implements Comparable<HttpRequestResponseInfo> {
	...
	public HttpRequestResponseInfo(String remoteHostName, PacketDirection direction) {
		if (direction == null) {
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has chunkModeFinished, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has rangeResponse, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has IfModifiedSince, and is false otherwise
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has ifNoneMatch, and is false otherwise.
	 */
	...
	public void setContentOffsetLength(SortedMap<Integer, Integer> contentOffsetLength) {
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has CacheHeaders, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has PragmaNoCache, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has NoCache, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has NoStore, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has PublicCache, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has PrivateCache, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has MustRevalidate, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has ProxyRevalidate, and is false otherwise.
	 */
	 ...
	 * 
	 * @return A boolean value that is true if the request/response has OnlyIfCached, and is false otherwise.
	 */
	...
	/**
	 * Returns the associated HTTP request/response. For instance, if this object contains an HTTP request, then this method will return the HTTP response
	...
	/**
	 * Returns the waterfall information for this request/response pair. This is only set when the direction is "REQUEST" and there is an associated response.
	 * 
	 * @return
	 */
	...
	public int compareTo(HttpRequestResponseInfo resInfo) {
		return Double.valueOf(getTimeStamp()).compareTo(Double.valueOf(resInfo.getTimeStamp()));
	}

	/**
	 * Returns the timestamp of the first packet associated with this HttpRequestResponseInfo . This is the offset of the request/response within the current
	 * trace.
	 * 
	 * @return A double that is the first packet timestamp associated with this HttpRequestResponseInfo. If the first packet is null, then this method returns
	 *         0.
	 */
	 ...
	 * 
	 * @return The first packet Date associated with the HttpRequestResponseInfo. If the first packet is null, then this method returns null.
	 */
	...
	/**
	 * Returns the session associated with this request. Responses do not have a Session recorded. YET.
	 * 
	 * @return Session
	 */
