...
public class TCPUDPFlowsTableModel extends DataTableModel<Session> {
	...
	private static final String[] COLUMNNAMES = { ResourceBundleHelper.getMessageString("tcp.time"), "", // Empty column
																											// name for
																											// checkbox
																											// selection
	 ...
	 * Temporary Fix
	 * 
	 * VO is using start time to check duplicate, but some sessions might have same
